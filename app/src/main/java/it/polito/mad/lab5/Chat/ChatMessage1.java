...
public class ChatMessage1 {
    ...
    public ChatMessage1(String messageText, String messageUser, String uID, Boolean seen) {
        this.messageText = messageText;
        this.messageUser = messageUser;
        this.uID = uID;
        this.seen = seen;
    ...
    public ChatMessage1(String messageText, String messageUser, String uID, String messageTime, Boolean seen) {
        this.messageText = messageText;
        this.messageUser = messageUser;
        this.uID = uID;
        // Initialize to current time
